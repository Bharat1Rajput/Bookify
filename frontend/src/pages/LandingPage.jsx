  ...
  const features = [
    {
      ...
      description:
        "AI-powered scheduling that finds the perfect time slots for everyone",
    },
    {
      icon: Clock,
      title: "Real-time Updates",
      description:
        "Get instant notifications about appointment changes and reminders",
    },
    {
      icon: Users,
      title: "Team Collaboration",
      description:
        "Seamlessly coordinate appointments across teams and departments",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      role: "Business Owner",
      content:
        "This app transformed how we manage appointments. Our no-show rate dropped by 80%!",
      rating: 5,
    },
    {
      ...
      content:
        "The automated reminders and easy rescheduling features save us hours every week.",
      rating: 5,
    },
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                  Time is the one resource we can never earn back. Every missed
                  appointment is a missed opportunity for growth, for
                  connection, for success. That’s why we built this platform: to
                  help you take control of your schedule, eliminate the chaos of
                  double bookings, and make every minute count.
                  <br />
                  Because when your time is organized, your goals are closer
                  than ever.
                </p>
              </div>
                ...
                <div className="space-y-8">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 text-lg">
                      Join thousands of professionals who trust Bookify for
                  ...
                  <div className="space-y-4">
                    <button
                      ...
                      className="w-full py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold text-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center group"
                    >
                    ...
                    <button
                      onClick={loginHandle}
                      className="w-full py-4 border-2 border-gray-200 text-gray-700 rounded-xl font-semibold text-lg hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 transition-all duration-300"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful features designed to streamline your scheduling process
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 hover:shadow-xl hover:scale-105 transition-all duration-300"
              >
      ...
      <section className="py-24 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Join thousands of businesses already using Bookify to streamline
            their operations
          </p>
          <button
